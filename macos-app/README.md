...
- [ ] The dictionary panel now has a **frosted-glass material card** (the page shows through faintly, like the system Look Up panel) instead of an opaque background, in both light and dark mode.
